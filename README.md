...
```sh
node tests.js            # terminal
# or open http://localhost:8080/tests.html
```

They pin down every row of the table below, plus over rollover, undo across boundaries,
innings-end conditions, mid-match config changes, and result wording.
...
wickets, match history, and export. This is a team-level counter by design. The delivery
log has room for all of it if that changes.
